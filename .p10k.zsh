# Generated by Powerlevel10k configuration wizard on 2020-07-27 at 01:51 EDT.
...
# no frame, sparse, fluent, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VICMD,VIVIS,VIOWR}_FOREGROUND=8
  # White prompt symbol for insert mode
